...
export default function BasicGrid() {
  ...
  const [foucusedPath, setFoucusedPath] = useState("C:\\Users\\suesa\\Downloads\\comic\\onepiece");
  ...
  useEffect(() => {
    setTabItems([
      {
        icon: <FolderIcon />,
        component: <ImageList loadFile={loadFile} currentFile={realPath} foucusedPath={foucusedPath} setFoucusedPath={foucusePath} />
      },
      {
        icon: <ImageIcon />,
        component: <ImageList loadFile={loadFile} currentFile={realPath} foucusedPath={foucusedPath} setFoucusedPath={foucusePath} />
  ...
  const foucusePath = (path: string) => {
    ...
    setTabItems([
      {
        icon: <FolderIcon />,
        component: <ImageList loadFile={loadFile} currentFile={realPath} foucusedPath={path} setFoucusedPath={foucusePath} />
      },
      {
        icon: <ImageIcon />,
        component: <ImageList loadFile={loadFile} currentFile={realPath} foucusedPath={path} setFoucusedPath={foucusePath} />
  ...
  return (
    <Box sx={{ 
      ...
      <Grid container spacing={0} sx={{ flex: 1 }}>
        ...
        <Grid size={10}>
          <Item><img src={file} style={{maxHeight:"71.0em",maxWidth:"71.0em"}}/></Item>
        </Grid>
      </Grid>
    </Box>
  );
